<?php /* Smarty version 2.6.26, created on 2014-11-20 13:46:46
...
"> [<?php echo $this->_sections['countpage']['index']; ?>
	...
	<?php endif; ?>
	<tr><th>Referencia</th><th width="160">Ausente</th><th width="160">Destinatario</th><th width="140">Postou</th></tr>
...
&amp;forward=true">Avancar</a></td>
		<td align="center" width="25%"><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=mail&amp;mode=arch">Arquivar</a></td>
		<td align="center" width="25%"><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
