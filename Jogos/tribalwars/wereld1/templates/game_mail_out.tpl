...
{else}
	{if empty($error)}
		...
		<td align="center" width="25%"><a href="game.php?village={$village.id}&amp;screen=mail&amp;action=del&amp;id={$mail.id}&amp;mode=out&amp;h={$hkey}">Löschen</a></td>
		</tr>
		</table>
		...
		<td align="center"><a href="game.php?village={$village.id}&amp;screen=mail&amp;mode=block&amp;action=block_id&amp;id={$mail.to_id}&amp;h={$hkey}">Empfänger blockieren</a></td>
		</tr>
		</table><br />
	{/if}
{/if}