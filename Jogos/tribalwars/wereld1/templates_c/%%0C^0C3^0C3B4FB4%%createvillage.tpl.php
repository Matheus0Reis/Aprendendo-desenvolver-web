<?php /* Smarty version 2.6.26, created on 2014-07-01 17:20:49
...
<head>
	...
	<link rel="icon" href="<?php echo $this->_tpl_vars['config']['cdn']; ?>
/rabe.png" type="image/x-icon"> 
	<link rel="shortcut icon" href="<?php echo $this->_tpl_vars['config']['cdn']; ?>
/rabe.png" type="image/x-icon">
	<title>Construir nova aldeia - <?php echo $this->_tpl_vars['config']['name']; ?>
</title>
...
<table class="principal" align="center" style="width:800px; min-width:800px;">
	<tr>
		<td>
			...
			<div class="error">Você teve sua última/única aldeia dominada por <?php echo $this->_tpl_vars['ennobled_by']; ?>
. Felizmente alguns de seus guerreiros sobreviveram e estão dispostos a combater este jogador e retomar o que é seu por direito. Caso queira entrar nesta guerra...</div>
			<?php endif; ?>
...
/graphic/richtung/richtung.png" alt="" /></td>
				</tr>
			</table>
		</td>
	</tr>
...
<table class="principal" style="width:800px; min-width:800px; margin-bottom: 30px;" align="center">
	<tr><th style="text-align:center;">&copy;<?php echo date('Y'); ?> | <?php echo $this->_tpl_vars['config']['name']; ?>
 - Todos os direitos reservados</th></tr>
</table>
