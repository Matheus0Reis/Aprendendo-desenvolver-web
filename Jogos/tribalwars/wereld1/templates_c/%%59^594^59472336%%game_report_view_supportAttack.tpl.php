...
<table width="100%">
	<tr>
		<th width="60">Jogador suportado:</th><th>
...
<tr><td>Origem das tropas:</td><td><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
...
" alt="" /></th>
	...
	<tr><td>Numero:</td><?php $_from = $this->_tpl_vars['report_units']['units_a']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
