...
</a> <?php if ($this->_tpl_vars['reports'][$this->_tpl_vars['key']]['is_new'] == '1'): ?>(novo)<?php endif; ?></td>
					<td><?php echo $this->_tpl_vars['reports'][$this->_tpl_vars['key']]['date']; ?>
</td>
				</tr>
			<?php endforeach; endif; unset($_from); ?>
			<tr>
				<th><input name="all" type="checkbox" onclick="selectAll(this.form, this.checked)" /> Selecionar tudo </th>
				<th><div align="center"><input type="submit" value="Excluir" name="del" /></div></th>
			</tr>
		<?php endif; ?>
	</table>
</form>