...
<table class="main" width="100%" align="center">
	<tr>
		<td>
			...
			//]]></script>
			<h4>§1) Uma conta por mundo</h4>
			<p>Você não tem permissão para ter mais de 1 conta por mundo.<br />
			<div id="more_1" style="display: none">
				<ul>
					<li>É proibido compartilhar senhas com jogadores do mesmo mundo.</li>
			...
			<span id="link_"><a id="link_1" href="?rule=1" onclick="return toggleRule(1);" style="font-size: x-small">&raquo; Mais</a></span>
			</p>
