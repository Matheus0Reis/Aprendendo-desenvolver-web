var TWMap = {
    ...
    graphics: null,
    image_base: null,
    images: ['vil_1n.png', 'vil_2n.png', 'vil_3n.png', 'vil_4n.png', 'vil_5n.png', 'vil_6n.png', 'left_1n.jpg', 'left_2n.jpg', 'left_3n.jpg', 'left_4n.jpg', 'left_5n.jpg', 'left_6n.jpg', 'grass1.png', 'grass2.png', 'grass3.png', 'grass4.png', 'grass5.png', 'grass6.png', 'grass7.png', 'grass8.png'],
    images_secret_blue: [],
    ...
    mapHandler: {
        ...
        loadSectors: function (sectors) {
            ...
            if (this._sector_request_queue.length > 0) {
                var query_string = 'json.php?e=' + ((new Date()).getTime());
    ...
    notifySavedChanges: function () {
        DWAR.print_info(TWMap.strings.changesSaved)
    },
    ...
    context: {
        ...
        spawn: function (village, x, y) {
            ...
            $(button_order).each(function (k, v) {
                ...
                if (TWMap.urls.ctx[v]) {
                    var url = TWMap.urls.ctx[v].replace(/__village__/, village.id).replace(/__owner__/, village.owner);
                    if (url.match(/json=1/)) {
