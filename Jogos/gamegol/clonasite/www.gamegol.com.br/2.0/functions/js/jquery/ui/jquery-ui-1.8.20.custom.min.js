...
function preparaDialog(idObj,urlImgTopSplash,pathImages){
	if(!pathImages){
		pathImages = '../functions/js/jquery/ui/imgs/';
	};
	
	/*apaga objetos criados para evitar duplicidade*/
	$('[splash=logo]',$('.ui-dialog-titlebar',$('[aria-labelledby=ui-dialog-title-'+idObj+']'))).remove()
//	$('[splash=titulo]',$('.ui-dialog-titlebar',$('[aria-labelledby=ui-dialog-title-'+idObj+']'))).remove()
	...
	/*estilo da barra de titulo geral*/
	/*inserção de logo do topo*/
	$('.ui-dialog-titlebar',$('[aria-labelledby=ui-dialog-title-'+idObj+']'))
	.css({
		'border':'none',
		'padding':'0px',
		'height':'64px',
		...
		'background-image':'url('+pathImages+'fundoTopo.jpg)',
	...
	.append(
		...
		.css({
			...
			'background-attachment':'inherit',
			'background-image':'url('+pathImages+'logoMensagem.png)',
			'background-position':'center top',
			'background-repeat':'no-repeat',
			'left':'0px',
			'top':'0px',
			'z-index':'1002',
			'left': ($('[aria-labelledby=ui-dialog-title-'+idObj+']').width())/2 - 91+'px'
		}).attr('splash','logo')
	)
	.append(
		$('<div></div>')
		.css({
			...
			'background-attachment':'inherit',
			'background-image':'url('+pathImages+'barraFundoTopo.jpg)',
	...
	/*estilo do title*/
	$('.ui-dialog-title',$('[aria-labelledby=ui-dialog-title-'+idObj+']'))
	.css({
		...
		'background-color':'transparent',
		'background-attachment':'inherit',
		'background-image':'url('+pathImages+'barraTitulo.jpg)',
		'background-position':'center top',
		'background-repeat':'repeat-x',
		'color':'#FFF',
		'overflow':'hidden',
	...
	window.setTimeout(function(){$('[splash=titulo]',$('[aria-labelledby=ui-dialog-title-'+idObj+']')).css('margin-left',((($('[aria-labelledby=ui-dialog-title-'+idObj+']').width())/2 - ($('#ui-dialog-title-'+idObj).width())/2)-20)+'px')},0);	
	
	/*estilo do botão fechar*/
	$('.ui-dialog-titlebar-close','[aria-labelledby=ui-dialog-title-'+idObj+']')
	.css({
		'width':'16px',
		'height':'16px',
		'display':'block',
		...
		'background-color':'transparent',
		'background-attachment':'inherit',
		'background-image':'url('+pathImages+'fechar.png)',
		'background-position':'center top',
		'background-repeat':'no-repeat',
		'cursor':'pointer'
	})
	...
	$('span',$('.ui-dialog-titlebar-close','[aria-labelledby=ui-dialog-title-'+idObj+']')).remove();
	...
	/*ajusta área dos botões*/
	$('.ui-dialog-buttonpane','[aria-labelledby=ui-dialog-title-'+idObj+']').css({
	...
	/*ajusta botões*/
	$('span',$('.ui-dialog-buttonpane','[aria-labelledby=ui-dialog-title-'+idObj+']')).css({
		'padding':'3px 10px 3px 10px',
		'color':'#fff'
	});
	$('.ui-state-default',$('.ui-dialog-buttonpane','[aria-labelledby=ui-dialog-title-'+idObj+']')).css({
		'background-color':'#00395d',
		'background-attachment':'inherit',
		'background-image':'url('+pathImages+'fundoBt.jpg)',
		'background-position':'center top',
		'background-repeat':'repeat-x',
		...
		'-o-border-radius':'5px', 
		'border-radius':'5px;',
		'border':'1px solid #26627d'
	})
	.bind('mouseover',function(){
		$(this).removeClass('ui-state-hover').css({
			'background-image':'url('+pathImages+'fundoBtHover.jpg)',
			'border':'1px solid #307290'
		})
	})
	...
	if(urlImgTopSplash){
		if(urlImgTopSplash.length > 0){
			if(urlImgTopSplash.indexOf('super_esportes') != -1){
				$('[splash=logo]',$('[aria-labelledby=ui-dialog-title-'+idObj+']')).css({
					'background-image':'url('+ urlImgTopSplash +')',
					'width':'277px',
					'margin-top':'-30px',
					'left': ($('[aria-labelledby=ui-dialog-title-'+idObj+']').width())/2 - 138+'px'
				})
			}
		}
	}
	...
	/*ajusta posicoes do titulo e da logo de topo*/
	$('[aria-labelledby=ui-dialog-title-'+idObj+']').bind('resize',function(){
		$('[splash=logo]',this).css('left', ($('[aria-labelledby=ui-dialog-title-'+idObj+']').width())/2 - 91+'px')
		$('[splash=titulo]',this).css('margin-left',((($('[aria-labelledby=ui-dialog-title-'+idObj+']').width())/2 - ($('#ui-dialog-title-'+idObj).width())/2)-20)+'px')
		if(urlImgTopSplash){
			if(urlImgTopSplash.length){
				if(urlImgTopSplash.indexOf('super_esportes.png') >= 0){
					$('[splash=logo]',this).css('left', ($('[aria-labelledby=ui-dialog-title-'+idObj+']').width())/2 - 138+'px')
				}else{
					$('[splash=logo]',this).css('left', ($('[aria-labelledby=ui-dialog-title-'+idObj+']').width())/2 - 91+'px')
				}
			}else{
