...
$cl_units->set_description("O Lanceiro é a unidade mais simples em jogo. Ele é especialmente eficiente na defesa contra cavaleiros.");
...
$cl_units->set_col("A");
$cl_units->set_attType("def");
$cl_units->set_description("O Espadachim é apropriado para a defesa contra infantaria. É, porém, relativamente lento.");

$cl_units->add_unit("Bárbaro","unit_axe");
...
$cl_units->set_description("O Bárbaro é uma unidade ofensiva de grande força. De maneira selvagem eles enfrentam os inimigos, atacando todos os que estejam em frente");
...
$cl_units->set_description("O Espião se infiltra em aldeias inimigas afim de obter informações importantes sobre as mesmas.");
...
$cl_units->set_col("B");
$cl_units->set_attType("off");
$cl_units->set_description("A Cavalaria leve é em especial indicada para ataques surpresa a aldeias inimigas.");
...
$cl_units->set_col("B");
$cl_units->set_attType("def");
$cl_units->set_description("A Cavalaria Pesada é a elite das tropas. Os mais nobres cavaleiros dispõem de armas robustas e fortes armaduras.");
...
$cl_units->set_col("C");
$cl_units->set_attType("off");
$cl_units->set_description("O Aríete é de grande ajuda em ataques, pois tem a capacidade de destruir Muralhas.");
...
$cl_units->set_description("A Catapulta é especialmente indicada para a destruição de edifícios inimigos.");
...
$cl_units->set_col("D");
$cl_units->set_attType("undefined");
$cl_units->set_description("O Nobre pode, por meio de ataques, diminuir a lealdade de uma aldeia inimiga. Após seus ataques a aldeia pode então ser conquistada. Os custos para a formação de um Nobre crescem a cada aldeia conquistada e com cada Nobre já existente ou em produção.");
?>