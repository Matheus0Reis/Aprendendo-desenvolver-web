...
$cl_units->set_description("O Lanceiro щ a unidade mais simples em jogo. Ele щ especialmente eficiente na defesa contra cavaleiros.");
...
$cl_units->set_col("A");
$cl_units->set_attType("def");
$cl_units->set_description("O Espadachim щ apropriado para a defesa contra infantaria. Щ, porщm, relativamente lento.");

$cl_units->add_unit("Bсrbaro","unit_axe");
...
$cl_units->set_description("O Bсrbaro щ uma unidade ofensiva de grande forчa. De maneira selvagem eles enfrentam os inimigos, atacando todos os que estejam em frente");
...
$cl_units->set_description("O Espiуo se infiltra em aldeias inimigas afim de obter informaчѕes importantes sobre as mesmas.");
...
$cl_units->set_col("B");
$cl_units->set_attType("off");
$cl_units->set_description("A Cavalaria leve щ em especial indicada para ataques surpresa a aldeias inimigas.");
...
$cl_units->set_col("B");
$cl_units->set_attType("def");
$cl_units->set_description("A Cavalaria Pesada щ a elite das tropas. Os mais nobres cavaleiros dispѕem de armas robustas e fortes armaduras.");
...
$cl_units->set_col("C");
$cl_units->set_attType("off");
$cl_units->set_description("O Arэete щ de grande ajuda em ataques, pois tem a capacidade de destruir Muralhas.");
...
$cl_units->set_description("A Catapulta щ especialmente indicada para a destruiчуo de edifэcios inimigos.");
...
$cl_units->set_col("D");
$cl_units->set_attType("undefined");
$cl_units->set_description("O Nobre pode, por meio de ataques, diminuir a lealdade de uma aldeia inimiga. Apѓs seus ataques a aldeia pode entуo ser conquistada. Os custos para a formaчуo de um Nobre crescem a cada aldeia conquistada e com cada Nobre jс existente ou em produчуo.");
?>