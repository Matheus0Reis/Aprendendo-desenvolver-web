...
{/php}</td></tr>
        ...
        <tr id="edit_row"><td colspan="2"><textarea id="message" name="desc_text" cols="40" rows="15">{$ally.edit_description|replace:"wurde von":"foi criada por"|replace:" gegründet":"."|replace:"Wendet euch bei Fragen an":"Qualquer duvida contate "|replace:"Dieser Text kann von den Diplomaten des Stammes geändert werden.":"Este texto pode ser modificado pelos Diplomatas da tribo"}</textarea></td></tr>
