...
{php}
	if($stufen == "yes")
	{
		echo "<a href=\"game.php?screen=overview&stufen=no&village=".$_GET[village]."\"> Esconder níveis dos edifícios</a>";
	}
	else
	{
		echo "<a href=\"game.php?screen=overview&stufen=yes&village=".$_GET[village]."\"> Mostrar níveis dos edifícios</a>";
	}
{/php}
...
<td align="right"><a href="game.php?overview=old&screen=overview&village={php}echo $_GET[village];{/php}"> visualização clássica da aldeia</a></td>
...
" /> {php} echo $this->_tpl_vars['village'][$this->_tpl_vars['dbname']]; {/php}
		...
		<td valign="top">
			<table class="vis" width="250">
				<tr><th colspan="2" class="fonte9">Produção</th></tr>
...
.png"> <strong class="meu">{php} echo $this->_tpl_vars['num']; {/php}
			...
			<table class="vis" width="100%">
				  <tr>
				    <th class="fonte9">Grupos / Afiliação</th>
				  </tr>
...
&amp;type=own">
				            <img src="graphic/command/{php} echo $this->_tpl_vars['array']['type']; {/php}
.png"> {$array.message|replace:"Angriff auf":"Ataque à"|replace:"Rückkehr von":"Retorno de"|replace:"Rückzug von":"Retirada de"|replace:"Unterstützung für":"Apoio à"}
...
</a> <strong class="meu">(Nível {php} echo $this->_tpl_vars['village'][$this->_tpl_vars['dbname']]; {/php}
)</strong></td>{php} if ($this->_tpl_vars['dbname'] == "market") { /*echo "<td><strong class="meu2">Mercadores: 8/10</strong></td>";*/ } {/php}
					</tr>
				{php} endforeach; endif; unset($_from); {/php}
			</table>
<br><a href="game.php?overview=new&screen=overview&village={php}echo $_GET[village];{/php}"><b> visualização gráfica da aldeia</b></a>
		</td>
		<td valign="top">
			<table class="vis" width="250">
				<tr><th colspan="2" class="fonte9">Produção</th></tr>
