...
if ($do=="cancel_buddy"){
   ...
   if ($control_number==1){
      ...
      header("Location: game.php?village=$id_village&screen=friends");
         ...
         header("Location: game.php?village=$id_village&screen=friends&error=O jogador não existe!");
   }
...
if ($do=="delete_buddy"){
   ...
   if ($control_number==1){
      ...
      if ($control_number_block==0) {
         ...
         $title="$name_player deletou você de sua lista de amigos.";
...
if ($do=="add_buddy"){
   ...
   $error="O Jogador $add_name não existe!";
      ...
      if ($id_newfriend<>$id_player){
         ...
         if ($nr_result_ver==0) {
            ...
            header("Location: game.php?village=$id_village&screen=friends");
             ...
             header("Location: game.php?village=$id_village&screen=friends&error=O jogador $add_name já existe na sua lista de amigos!");
         }
      } else {
         header("Location: game.php?village=$id_village&screen=friends&error=Você não pode adicionar-se na lista de amigos!");
      }
...
<h3>Seus convites</h3> 
<table class="vis"> 
<tr><th>Jogador</th><th colspan="2">Ação</th></tr> 
{php}
...
<tr> 
	...
	<td><a href="game.php?village={$village.id}&amp;screen=friends&amp;action=reject_buddy&amp;buddy_id={php}echo $value{/php}" onclick="return confirm('Certeza que não deseja adicionar este jogador a sua lista de amigos?')">Recusar</a></td> 
</tr> 
{php}}{/php}
</table> 
{php}}{/php}
