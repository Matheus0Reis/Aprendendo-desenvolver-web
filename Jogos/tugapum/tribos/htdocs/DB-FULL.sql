...
-- 
-- Host: localhost
-- Generation Time: Dec 12, 2010 at 03:09 PM
...
CREATE TABLE `ally` (
  ...
  `intro_igm` varchar(1000) collate utf8_unicode_ci NOT NULL,
...
INSERT INTO `create_village` VALUES (25, 25, 22, 23, 81, 77, 76, 77, 63, 74, 75, 61, 3);
...
CREATE TABLE `login` (
  `login_locked` enum('yes','no','reset') character set latin1 collate latin1_german1_ci NOT NULL default 'no',
...
CREATE TABLE `users` (
  `id` int(11) NOT NULL auto_increment,
  `username` varchar(150) character set latin1 collate latin1_general_ci default NULL,
  ...
  `confirm_queue` int(1) NOT NULL default '0',
  `map_size` int(2) NOT NULL default '13',
...
CREATE TABLE `villages` (
  ...
  `userid` int(11) NOT NULL,
  `r_wood` varchar(230) collate utf8_unicode_ci default '50000',
  `r_stone` varchar(230) collate utf8_unicode_ci default '50000',
  `r_iron` varchar(230) collate utf8_unicode_ci default '40000',
  ...
  `unit_archer_tec_level` int(11) default '0',
  `unit_spy_tec_level` int(11) default '1',
  `unit_light_tec_level` int(11) default '0',
  `unit_marcher_tec_level` int(11) default '0',
