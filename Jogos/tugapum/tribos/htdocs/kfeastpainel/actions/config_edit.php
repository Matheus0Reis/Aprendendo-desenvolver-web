...
if(isset($_GET["update"]) && $_GET["update"] == "y") {
	...
	if($fp) {
		$dslan_plugin->display_action("Configura&ccedil;&otilde;es Salvas<script type='text/javascript'>alert('Feito!');top.location.href='index.php?screen=config_edit';</script>", "ok");
	}
	else {
		$dslan_plugin->display_action("Configura&ccedil;&otilde;es Perdidas", "error");
	}
}
