...
{php}if ($_GET['mode'] == "allticket"){{/php}
...
{php}if ($_GET['mode'] == "newticket"){{/php}
<div class="outerBorder"> 
	<div class="innerBorder"><div class="innerBG"> </div></div>
<table class="vis" width="100%" border="0">
  <tr>
...
{php}if ($_GET['mode'] == "blockticket"){{/php}
<div class="outerBorder"> 
	<div class="innerBorder"><div class="innerBG"> </div></div>
<table class="vis" width="100%" border="0">
  <tr>
...
<table class="vis" width="100%" border="0">
  <tr>
  <th colspan="2"><div align="center">{php} echo "$mostrar[assunto]"; {/php}</div></td>  </tr>
  <tr>
    <td width="26%">Tipo :</td>
  ...
  <tr>
    <td width="26%">Data :</td>
    <td>{php} echo "$mostrar[time]"; {/php}</td>
  </tr>
  <tr>
...
<div class="post"> 
				<div class="igmline"> 
					...
					elseif ($mostrar["jog"] >= "1") {{/php}<a href="game.php?village={$village.id}&amp;screen=info_player&amp;id={php} echo "$mostrar[jog]"; {/php}">{php}}{/php}{php} echo "$text_f"; {/php}</a></span> 
					 <span class="right date">{php} echo "$mostrar[data]"; {/php}</span>				</div> 
				<div class="text">{php} echo nl2br(bb_format($mostrar['txt'])); {/php} 
</div> 
</div>
<br />
<table class="vis" width="100%" border="0">
<form method="post" action="index.php?screen=Support&post={php} echo "$mostrar[id]";{/php}&action=postar">
 <tr>
 <tr>
