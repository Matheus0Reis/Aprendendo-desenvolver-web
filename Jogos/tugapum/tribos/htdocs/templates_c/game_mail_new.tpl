...
<p id="igm_affront_hint" class="error" align="center">Insultos a jogadores podem resultar em bloqueio de contas!</p>
  ...
  <table class="vis">
    <tbody>
      <tr><td>Para:</td><td>
          ...
          <a href="javascript:popup_scroll('igm_to.php?', 250, 300)">Mensagem em massa</a>{/if}</td>
      </tr>
      <tr><td>Assunto:</td><td>
          <input type="text" name="subject" size="50" value="{$inputs.subject|replace:"Re:":""|replace:"Fw: ":""|replace:"Willkommen bei":"Bem Vindo à tribo"}" /></td>
      </tr>
    <tr id="bbcode">
        <td colspan="2">
        ...
        <tr>
            ...
            <td colspan="2">
                <textarea id="message" name="text" tabindex="3" cols="70" rows="16">{$inputs.text|replace:"schrieb:":"escreveu o seguinte:"|replace:"Stamm":"Tribo"}</textarea>
            </td>
        </tr>
        <tr>
...
<input type="submit" name="preview" value="Visualizar" /> <input type="submit" name="send" value="Enviar">
</form> 