...
function bb_format($test) {
    ...
    $simple_replace = array(  
                ...
                '<table class="quote"><tbody><tr><td></td><td class="quote_author">$1 escreveu o seguinte:</td></tr><tr><td width="10"></td><td class="quote_message">$2</td></tr></tbody></table>',  
